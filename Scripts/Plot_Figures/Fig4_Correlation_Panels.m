...
% cpc6, cpc2, chrTableHyb, 
saveFolder = 'U:\Manuscripts\SE Clustering Paper\Data\';
chrTableHyb = readtable([saveFolder,'chrTableHyb_mm10.csv']) ; % mm10  

%%

chipTable = readtable([saveFolder,'average_normalized_peak_count_H3K27ac_SE.xlsx'])
chipTable2 = readtable([saveFolder,'mESC_normalized_peak_count_OSN_med1_pol2_SE.xlsx']);
chipTable2 = chipTable2(1:376,:);
load([saveFolder,'speckleSE.mat'],'speckleSE');
load([saveFolder,'LADscore.mat'],'lad_score');
load([saveFolder,'cpc6.mat'],'cpc6','chrTableHyb');
...
%% plot correlates
pol2 = mean([chipTable2.PolII_r1_normalized,chipTable2.PolII_r1_normalized],2);
med1 = mean([chipTable2.med1_r1_normalized,chipTable2.med1_r1_normalized],2);
figure(4); clf;
% xVars = {eclose, eWeight, chipTable2.NANOG_normalized,chipTable2.POU5F1_normalized,chipTable2.SOX2_normalized,speckleSE,chipTable2.PolII_r1_normalized,chipTable2.PolII_r2_normalized,chipTable.Bingren_mESC_H3K27ac_r1,chipTable2.med1_r1_normalized,chipTable2.med1_r2_normalized,chipTable2.lad};
% xName = {'# SE <1Mb','weighted distance 1/\Sigma_i(d_i)','Nanog','Oct4','Sox2','Speckle','PolII','PolII r2','H3K27ac','Med1','Med1 r2','LAD'}
xVars = {eclose, eWeight, chipTable2.NANOG_normalized,chipTable2.POU5F1_normalized,chipTable2.SOX2_normalized,chipTable.Bingren_mESC_H3K27ac_r1, pol2,med1,chipTable2.lad,speckleSE};
...
figure(5); clf;
figure(4); clf;
xVars = {eclose, eWeight, chipTable2.NANOG_normalized,chipTable2.POU5F1_normalized,chipTable2.SOX2_normalized,speckleSE,chipTable2.PolII_r1_normalized,chipTable2.PolII_r2_normalized,chipTable.Bingren_mESC_H3K27ac_r1,chipTable2.med1_r1_normalized,chipTable2.med1_r2_normalized};
xName = {'# SE <1Mb','weighted distance 1/\Sigma_i(d_i)','Nanog','Oct4','Sox2','Speckle','PolII','PolII r2','H3K27ac','Med1','Med1 r2'}
rp = zeros(12,2);
for x=1:length(xVars) % x=6
